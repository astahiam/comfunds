-- ============================================
-- STANDALONE RESTORE SCRIPT FOR comfunds02
-- ============================================
-- This is a COMPLETELY SELF-CONTAINED script
-- Usage: psql -U postgres -d postgres -f comfunds02_standalone_restore.sql
-- Or: docker exec -i container_name psql -U postgres -d postgres < comfunds02_standalone_restore.sql
-- 
-- This file contains EVERYTHING needed to restore comfunds02:
-- 1. Database creation
