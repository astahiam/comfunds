...
type User struct {
	...
	MembershipPaymentProof *string    `json:"membership_payment_proof" db:"membership_payment_proof"`
...
type CreateUserRequest struct {
	...
	MembershipPaymentProof *string    `json:"membership_payment_proof" validate:"omitempty,max=500"`
