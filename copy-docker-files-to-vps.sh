...
$SSH_CMD "sudo mkdir -p $VPS_PATH"
$SSH_CMD "sudo mkdir -p $VPS_PATH/docker/nginx"
$SSH_CMD "sudo mkdir -p $VPS_PATH/docker/postgres"
$SSH_CMD "sudo mkdir -p $VPS_PATH/frontend"
$SSH_CMD "sudo mkdir -p $VPS_PATH/uploads"
$SSH_CMD "sudo mkdir -p $VPS_PATH/logs"
...
$SSH_CMD "sudo chown -R $VPS_USER:$VPS_USER $VPS_PATH"
$SSH_CMD "sudo chmod -R 755 $VPS_PATH"
$SSH_CMD "sudo find $VPS_PATH -type f -name '*.sh' -exec chmod +x {} \;"
$SSH_CMD "sudo chmod 600 $VPS_PATH/env.example"
$SSH_CMD "sudo chmod 600 $VPS_PATH/frontend/env.example"
...
$SSH_CMD "sudo chmod 600 $VPS_PATH/.env"
$SSH_CMD "sudo chmod 600 $VPS_PATH/frontend/.env"
